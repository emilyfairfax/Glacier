...
for i=1:1:imax
    ...
    %Tributary Calculations
        ...
        % Addition Array
            QaddTrib(junctionxarray) = QflowTrib(junctionxarray)./dx; %in the addition array, insert the flux at the junction point from the main glacier in the junction position

        
    %Recalculate with added ice from tributary
        iceslope = diff(iceelevation1)./dx; % calculate slopes on ice surface   
        ...
        if ticethickness1(junctionxarray)>0
